...
<button  onClick={()=>navigate('/')} className='btn btn-warning mx-3' style={{ fontWeight: "bold", fontSize: "1.2rem" }}> Continue Shopping... </button>
</div>
          ...
          <div key={product._id} className='container bg-dark my-5 p-3 text-center'>
            <div style={{ display: "flex", justifyContent: "space-around", alignItems: "center" }}>
              ...
              <div className="cart_action">
                ...
                <button className='btn btn-info mx-3' onClick={() => addToCart(product?.productId, product.title, product.price / product.qty, 1, product.imgsrc)} style={{ fontWeight: "bold" }}> Qty++</button>
                <button className='btn btn-danger mx-3'
                  ...
                  style={{ fontWeight: "bold" }}> remove{" "} </button>
              </div>
            </div>
          </div>
        )
  ...
  cart?.items?.length > 0 && (
    ...
    <div className="container text-center my-3">
        ...
        onClick={()=>{
         ...
         style={{fontWeight:"bold"}}>Clear Cart </button>
      </div>
